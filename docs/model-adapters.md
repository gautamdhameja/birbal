...
Select the provider with `MODEL_PROVIDER=llama_cpp` or `MODEL_PROVIDER=openai`. Provider endpoints, models, credentials, and token limits come from environment variables.
